...
{
    [TestClass]
    public class HulkPowerTest
    {
        public HulkPower _powerTest;
        ...
        [TestMethod]
        public void GetPowerHulk_LowerCase_Success()
        {
            //Arrange
        ...
        [TestMethod]
        public void GetPowerHulk_UpperCase_Success()
        {
            //Arrange
            string superHero = "HULK";
            _context.Create(superHero);
        ...
        [TestMethod]
        public void GetPowerHulk_AnotherHero_Error()
        {
            //Arrange
